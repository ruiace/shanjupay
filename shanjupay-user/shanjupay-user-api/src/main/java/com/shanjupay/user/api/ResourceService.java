...
public interface ResourceService {
     ...
     * @param application
     */
    void createApplication(ApplicationDTO application) throws BussinessException;
     ...
     * @param application
     */
    void modifyApplication(ApplicationDTO application) throws BussinessException;
     ...
     */
    void removeApplication(String applicationCode) throws BussinessException;
     ...
     * @return
     */
    ApplicationDTO queryApplication(String applicationCode) throws BussinessException;
    ...
    PageVO<ApplicationDTO> pageApplicationByConditions(ApplicationQueryParams query,
                                                     Integer pageNo, Integer pageSize) throws BussinessException;
     ...
     * @return
     */
    List<ResourceDTO> loadResources(List<String> privileageCodes, String applicationCode) throws BussinessException;
     ...
     */
    Map<Long, List<ResourceDTO>> loadResources(Map<Long, AuthorizationInfoDTO> tenantAuthorizationInfoMap) throws BussinessException;
