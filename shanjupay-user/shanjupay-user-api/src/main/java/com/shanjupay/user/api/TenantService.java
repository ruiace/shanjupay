...
public interface TenantService {
     ...
     * @param id 租户id
     */
    void removeTenant(Long id) throws BussinessException;
     ...
     * @return 租户信息
     */
    TenantDTO getTenant(Long id) throws BussinessException;
    ...
    PageVO<TenantDTO> queryTenants(TenantQueryDTO tenantQuery, Integer pageNo, Integer pageSize, String sortBy,
			String order) throws BussinessException;
     ...
     * @return
     */
    List<BundleDTO> queryBundleByTenantType(String tenantType) throws BussinessException;
...
////////////////////套餐管理start/////////////////////
     ...
     * @param bundleCode 套餐编码
     */
    void changeBundle(Long tenantId, String bundleCode) throws BussinessException;
    /**
     * 初始化租户套餐
     * 将限流规则写入sentinel
     * @param tenantId 租户id
     * @param bundleCode 套餐编码
     */
    void initBundle(Long tenantId, String bundleCode) throws BussinessException;

    /**
     * 新增套餐
     * @param bundleDTO
     */
    void createBundle(BundleDTO bundleDTO) throws BussinessException;

    /**
     * 更新套餐
     * @param bundleDTO
     */
    void modifyBundle(BundleDTO bundleDTO) throws BussinessException;
     ...
     */
    AccountDTO createAccount(CreateAccountRequestDTO createAccountRequest) throws BussinessException;
     ...
     * @param username 用户名
     */
    void bindTenant(Long tenantId, String username) throws BussinessException;
    ...
    // */
    //void bindTenantAccount(Long tenantId, Long accountId,Boolean isAdmin) throws BussinessException;
     ...
     * @param username 用户名
     */
    void unbindTenant(Long tenantId, String username) throws BussinessException;
     ...
     * @return
     */
    boolean isExistAccountByUsername(String username) throws BussinessException;
     ...
     * @return
     */
    boolean isExistAccountByMobile(String mobile) throws BussinessException;
     ...
     * @return 账号信息
     */
    AccountDTO getAccountByUsername(String username) throws BussinessException;
     ...
     * @return 账号信息
     */
    AccountDTO getAccountByMobile(String mobile) throws BussinessException;
     ...
     * @return
     */
    boolean isExistAccountInTenantByUsername(Long tenantId, String username) throws BussinessException;
     ...
     * @return
     */
    boolean isExistAccountInTenantByMobile(Long tenantId, String mobile) throws BussinessException;
     ...
     * @return
     */
    List<TenantDTO> queryAccountInTenant(String username) throws BussinessException;
     ...
     * @return 认证成功的账号信息
     */
    AccountDTO authentication(AuthenticationInfo authenticationInfo) throws BussinessException;
     ...
     *
     */
    LoginInfoDTO login(LoginRequestDTO loginRequest) throws BussinessException;
     ...
     * @throws BussinessException
     */
    ApplicationDTO getApplicationDTOByClientId(String clientId) throws BussinessException;
     ...
     * @throws BussinessException
     */
    public TenantDTO getTenantByAccount(Long accountId, Boolean isAdmin) throws BussinessException;
    ...
    // * @return
    // */
    //boolean queryTenantAccount(Long accountId, Boolean isAdmin) throws BussinessException;
