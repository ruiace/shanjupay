package com.shanjupay.paymentagent.api.common;
...
public class AliCodeConstants {
    ...
    public static final String SUCCESSCODE = "10000"; // 支付成功或接口调用成功 public static final String PAYINGCODE = "10003"; // 用户支付中
